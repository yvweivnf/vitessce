...
exports.default = exports.STRATEGY_REPLACE = exports.STRATEGY_NEVER = exports.STRATEGY_DEFAULT = void 0;
...
var Tileset2D = function () {
  function Tileset2D(opts) {
    ...
    this._frameNumber = 0;
    this._modelMatrix = new _math.Matrix4();
    this._modelMatrixInverse = new _math.Matrix4();
